...
public class ChartOffset {
    ...
    init(_ top: CGFloat, _ bottom: CGFloat, _ left: CGFloat, _ right: CGFloat) {
        self.top = top
        self.bottom = bottom
        self.left = left
        self.right = right
...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    public func getOffsets() -> ChartOffset
    {
        if !_customViewPortEnabled
        {
            ...
            return ChartOffset.init(offsetTop, offsetBottom, offsetLeft, offsetRight)
        }
        return ChartOffset()
    }
